...
function init() {
     ...
     // This makes sure that the confirm button will only save the chosen noodle to local storage 
     // and switch pages if a noodle is currently selected
      ...
      * @returns {Array.<boolean, HTMLDivElement>}
      */
     function changeSelected(gridItem){
          if (typeof changeSelected.currentlySelected === 'undefined') {
               ...
               submitOption.classList.remove('disabledBtn');
               ...
               submitOption.classList.add('disabledBtn');
